...
export function collectFrameData(frame: Frame, regionDefs: FigmaSpecConfig['regions']): Promise<RawFrameData> {
...
export async function frameOffset(page: Page, frame: Frame): Promise<{ x: number; y: number }> {
...
export function assignRegionKey(bbox: Rect, regions: LiveRegion[]): string | undefined {
